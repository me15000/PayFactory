...
namespace Pay.Alipay
{
    public class Submit
    {
        ...
        ConfigInfo config;
        public Submit(ConfigInfo config)
        {
            this.config = config;

            

            _key = config.SCode.Trim();
        ...
        {
            string url = GATEWAY_NEW + "service=query_timestamp&partner=" + this.config.PID + "&_input_charset=" + ConfigInfo.input_charset;
            string encrypt_key = "";
